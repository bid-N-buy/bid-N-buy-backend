...
public interface ImageRepository extends JpaRepository<ImageEntity, Long> {
    ...
    Optional<String> findMainImageUrl(Integer auctionId);

    // 상품 상세 조회
    List<ImageEntity> findAllByAuctionProduct_AuctionId(Integer auctionId);
    ...
    @Query("SELECT i.imageUrl FROM ImageEntity i " +
            ...
            "LIMIT 1")
    Optional<String> findFirstImageUrlByAuctionId(Integer auctionId);
